...
export const FormattedHTMLMessage = RI.FormattedHTMLMessage;
export const FormattedMessage = RI.FormattedMessage;
export const FormattedPlural = RI.FormattedPlural;
